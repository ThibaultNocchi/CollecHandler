...
export type SearchItemsQuery = { __typename?: 'Query', search: { __typename?: 'ItemsList', pages: number, total: number, items: Array<{ __typename?: 'Item', id: number, collectionId: number, name: string, quantity: number }> } };
